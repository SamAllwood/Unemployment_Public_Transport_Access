...
# Jobcentres Data - downloaded and filtered in 1._Public_Transport_Job_Access.R
...
# 3. Data Cleaning --------------------------------------------------------
# Join datasets
MANCH_dataset_full <- left_join(MANCH_dataset, Employment, by = c("LSOA_Code" = "id"), keep=FALSE) %>%
